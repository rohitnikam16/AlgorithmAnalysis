    ...
    auto start = high_resolution_clock::now(); 
		...
		{int p=0;
			start:
				...
				goto start;
				string gene=crossover(population[rand1].gnome,population[rand2].gnome);
				int f1=population[rand1].fitness;
				int f2=population[rand2].fitness;
				...
				if(f1<f2)
				{
					...
					{
						vis[rand2]=true;
						population[rand2].gnome=gene;
						population[rand2].fitness=f3;
					}
					else if(f3<f1)
					{
						vis[rand2]=true;
						population[rand2].gnome=population[rand1].gnome;
						population[rand2].fitness=f1;
						
						vis[rand1]=true;
						population[rand1].gnome=gene;
						population[rand1].fitness=f3;
						count++;
					}
				} else if(f2<f1){
					if(f3>=f2 && f3<f1)
					...
					{
						vis[rand1]=true;
						population[rand1].gnome=population[rand2].gnome;
						population[rand1].fitness=f2;
						
						vis[rand2]=true;
						population[rand2].gnome=gene;
						population[rand2].fitness=f3;count++;
					}
				}
			count++;
		}
